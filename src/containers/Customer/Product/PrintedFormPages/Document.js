...
class Document extends Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    if (prevProps.DocumentsRedux !== this.props.DocumentsRedux) {
      this.setState({
        arrDocuments: this.props.DocumentsRedux,
      });
    }
  }
  ...
  render() {
    let arrDocuments = this.state.arrDocuments;
    return (
      <>
        <HomeHeader />
        <Tab />
        <div className="product-page">
          <div className="product-content">
            <div className="product-header">
              <span className="title-section">Chứng từ</span>
            </div>
...
const mapStateToProps = (state) => {
  return {
    DocumentsRedux: state.product.documents,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    loadDocument: () => dispatch(actions.fetchDocument()),
  };
};
